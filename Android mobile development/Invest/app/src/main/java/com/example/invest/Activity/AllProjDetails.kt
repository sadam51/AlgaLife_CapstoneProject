...
class AllProjDetails : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageResource = when (project?.category?.lowercase()) {
            "cyber security" -> R.drawable.finance
            "data analytics" -> R.drawable.finance
            "ecommerce" -> R.drawable.finance
            "finance" -> R.drawable.finance
            "game" -> R.drawable.finance
            "healthcare" -> R.drawable.finance
            "education" -> R.drawable.finance
            "virtual reality" -> R.drawable.finance
